...
| **Netteté réelle** | 3840×2160 nominal, mais le piqué effectif est en dessous (optique action-cam + compression). Les textures fines sont molles en arrêt sur image. | Non bloquant à 1600 px de large. **Mais sur chaque timecode d'arrêt, il faut scruter ±5 images pour attraper la plus nette** — ne pas se fier au timecode rond. |
