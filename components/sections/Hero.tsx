...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div style={reduced ? undefined : { y }} className="absolute inset-0 scale-[1.08]">
        <Image
          src={unsplash("photo-1618221195710-dd6b41faaea6", 2400)}
          alt="Grand salon baigné de lumière naturelle, tons crème et bois clair"
          fill
          priority
          sizes="100vw"
      ...
      <div className="absolute inset-0 flex items-end px-4 pb-24 sm:px-8 lg:items-center lg:px-16 lg:pb-0">
        ...
        >
          ...
          <h1 className="font-display mt-6 text-[clamp(2.5rem,6.5vw,5.2rem)] leading-[0.98] tracking-tight">
            <RevealText
              text="On dessine des espaces qui vous ressemblent"
              start={ready}
              delay={0.35}
            />
          </h1>
          ...
          >
            Studio de design intérieur haut de gamme. Résidentiel et
            commercial, du concept à l&apos;installation.
          </motion.p>
          ...
          >
            ...
            <Button variant="glass" onClick={() => scrollToId("realisations")}>
          ...
          >
            ...
            >
              <p className="font-display text-2xl leading-none">120+</p>
